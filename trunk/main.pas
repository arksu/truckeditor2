...
type
  ...
  public
    ...
    procedure deselected_nodes;
    procedure deselected_beams;
...
procedure Teditor_form.deselected_beams;
var
  i : integer;
begin
  for i := 0 to num_beams(truck) - 1 do
...
procedure Teditor_form.deselected_nodes;
var
  i : integer;
begin
...
begin
  ...
  if (button=mbleft) and (mode_nodes.Down) and (nodes_select.Down) then begin
    ...
    end_rect := point(X, Y);
    if not (ssCtrl in Shift) then deselected_nodes;
  ...
  if (button=mbleft) and (mode_beams.Down) and (beams_select.Down) then begin
    if not (ssCtrl in Shift) then deselected_beams;
